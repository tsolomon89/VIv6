...
import 'field_string_model.dart';
export 'field_string_model.dart';

class FieldStringWidget extends StatefulWidget {
  const FieldStringWidget({
    super.key,
    this.propertyValue,
    this.fieldName,
  });
  ...
  @override
  State<FieldStringWidget> createState() => _FieldStringWidgetState();
}

class _FieldStringWidgetState extends State<FieldStringWidget> {
  late FieldStringModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FieldStringModel());
