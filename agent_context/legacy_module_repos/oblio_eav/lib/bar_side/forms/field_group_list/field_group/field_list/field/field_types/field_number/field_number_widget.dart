...
import 'field_number_model.dart';
export 'field_number_model.dart';

class FieldNumberWidget extends StatefulWidget {
  ...
  @override
  State<FieldNumberWidget> createState() => _FieldNumberWidgetState();
}

class _FieldNumberWidgetState extends State<FieldNumberWidget> {
  late FieldNumberModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FieldNumberModel());
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      onFieldSubmitted: (_) async {
        ...
        _model.addToDataEntered(PropertyStruct());
        safeSetState(() {});
      },
