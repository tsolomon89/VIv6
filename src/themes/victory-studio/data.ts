...
import { VICTORY_PAGE_TEMPLATE } from './templates/victory';
import { OBLIO_PAGE_TEMPLATE } from './templates/oblio';
import { KEIMENON_PAGE_TEMPLATE } from './templates/keimenon';
// Registry for Page Templates
// Updated for Hydration Debugging
// import { INITIAL_PAGE_TEMPLATE, MINIMAL_PAGE_TEMPLATE } from './templates/TEMPLATES';
...
export const DEFAULT_CONFIG: ConfigState = {
  ...
  baseWidth: mkParam(1),
  scale: mkParam(100),
  glow: mkParam(5), // Boosted
  noise: mkParam(0.5),
  bloom: mkParam(3), // Boosted
  hueShift: mkParam(0),
  ...
  rainbow: mkParam(1.0),
  density: mkParam(0.05), // Lowered for visibility
  opacity: mkParam(1.0),
  rotateX: mkParam(0),
  rotateY: mkParam(0),
  rotateZ: mkParam(0),
...
export const TEMPLATES: Record<string, PageTemplate> = {
    ...
    'victory-landing': VICTORY_PAGE_TEMPLATE,
    'oblio-landing': OBLIO_PAGE_TEMPLATE,
    'keimenon-parser': KEIMENON_PAGE_TEMPLATE
};
