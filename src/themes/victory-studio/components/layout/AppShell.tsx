...
export const AppShell: React.FC<AppShellProps> = ({ children, sidebarContent, isSidebarOpen, setScrollContainer, editorMode = 'sidebar' }) => {
    // Only shrink content if sidebar is open AND in sidebar mode
    const contentMargin = isSidebarOpen && editorMode === 'sidebar' ? '420px' : '0px';
